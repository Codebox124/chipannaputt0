...
const page = () => {
  return (
    <div>
      ...
      <section className=' w-full min-h-screen py-12 sm:py-16 md:py-20 lg:p-16 flex items-center justify-center px-4 sm:px-6 md:px-8'>

        <div className=' w-full md:w-[90%] lg:w-[80%] xl:w-[70%] ml-auto mr-auto'>
          <h1 className='text-2xl sm:text-3xl md:text-4xl lg:text-5xl tracking-tight leading-relaxed font-meduim mb-4 sm:mb-6 md:mb-8 text-center'>Mastering the fundamentals makes a better golfer</h1>
