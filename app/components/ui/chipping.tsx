...
const Chipping = () => {
    return (
        <div className='md:h-screen h-max w-full relative'>
            {/* Bg Image */}
            <Image src="/images/chipping.png" alt="Why Chipa" width={1920} height={1080} className='w-full h-[50vh] object-cover z-0' />
